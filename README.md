...
Current stage: M2.16 target memory/flash/CPU budget planning.

No PCB work, hardware build, flashable firmware image, RF transmit, real radio keying, real codec driver work, real USB stack, embedded USB implementation, real audio hardware path, real audio driver work, real clock setup, real watchdog setup, linker script, or final embedded memory map has started.
