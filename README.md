...
Current stage: M2.15 STM32H7 clock/reset/watchdog planning and metadata.

No PCB work, hardware build, flashable firmware image, RF transmit, real radio keying, real codec driver work, real USB stack, embedded USB implementation, real audio hardware path, real audio driver work, real clock setup, or real watchdog setup has started.
